...
!function() {
    ...
    $(function() {
        ...
        $(".room_items").on("click", ".room-item", j.selectItem),
        $(".right-bar,.bottom-bar").on("click", ".tool-item", d),
        $(".map-panel").on("click", function() {
            this.last_click = this.last_click || 0,
            500 < Date.now() - this.last_click ? this.last_click = Date.now() : M.show("map")
        }),
        $(".sender-btn").on("click", x),
        $(".room_exits").on("mousedown", j.before_click_exits).on("mouseup", j.click_exits),
    ...
    var n, t, o = {
        ...
        ResetPwd: function() {
            ...
            void L.UserAPI.ResetPasswordByPhone(e, t, s, i, function(e) {
                e ? (w("#reset_pwd2", e),
        ...
        CheckValid: function() {
            ...
            if (!s)
                return w($("#phone_valid").parent(), "请输入你接收到的六位验证码");
            if (!/^\d{6}$/.test(s))
                return w($("#phone_valid").parent(), "请输入六位数字的验证码");
            var i = $("#phone_pwd").val();
            return i ? i.length < 6 || 20 < i.length ? w("#phone_pwd", "密码长度在6到20之间") : void L.UserAPI.BindPhone(s, t, i, function(e) {
                e ? (w($("#phone_valid").parent(), e),
                HideAndShow("#bind_panel")) : HideAndShow("#role_panel")
            }) : w("#phone_pwd", "请重复输入你的新密码")
        },
        ReLogin: function() {
            HideAndShow($("#login_panel"));
            var e = new Date;
        ...
        UpdatePwd: function() {
            ...
            k("正在修改密码", "#pwd_panel"),
            L.UserAPI.ChangePassword(t, s, e, function(e) {
                e.code ? HideAndShow($("#slist_panel")) : (w("#update_pwd1", e.message || "修改失败"),
                HideAndShow("#pwd_panel"))
            })
        },
        LoginIn: function() {
            var e = $("#login_name").val().toLowerCase()
              , t = $("#login_pwd").val();
            return e ? /^[a-z0-9]{5,15}$/.test(e) ? t ? t.length < 6 || 20 < t.length ? w("#login_pwd", "密码长度在6到20之间") : (k("正在登录", "#login_panel"),
            void L.UserAPI.Login(e, t, function(e) {
                e.code ? l() : (w("#login_name", e.message || "登陆失败"),
                HideAndShow("#login_panel"))
        ...
        SelectRole: function() {
            ...
            e.length && (c("login " + e.attr("roleid")),
            k("正在进入游戏", "#role_panel"))
        },
        CreateRole: function() {
            var e = {};
            ...
            /^[\u4E00-\u9FA5]{2,5}$/.test(e.name) ? e.str < 15 || 30 < e.str ? w("#reg_name", "臂力需要在15-30之间") : e.con < 15 || 30 < e.con ? w("#reg_name", "根骨需要在15-30之间") : e.dex < 15 || 30 < e.dex ? w("#reg_name", "身法需要在15-30之间") : e.int < 15 || 30 < e.int ? w("#reg_name", "悟性需要在15-30之间") : e.str + e.con + e.dex + e.int != 80 ? w("#reg_name", "先天属性需要在15-30之间，并且总和等于80") : (k("正在创建角色", "#addrole_panel"),
            void c("createrole " + e.name + " " + e.gender + " " + e.str + " " + e.con + " " + e.dex + " " + e.int)) : w("#reg_name", "名称格式错误，只能使用2-5位中文字符")
        },
        AddRole: function() {
        ...
        Regist: function() {
            var e = $("#regist_name").val().toLowerCase()
              , t = $("#regist_pwd1").val();
            if (!e)
                return w("#regist_name", "请输入用户名");
            if (!/^[a-z0-9]{5,15}$/.test(e))
                return w("#regist_name", "用户名需要是5-10个英文字符");
            if (!t)
                return w("#regist_pwd1", "请输入密码");
            if (t.length < 6 || 20 < t.length)
                return w("#regist_pwd1", "密码长度在6到20之间");
            if (t != $("#regist_pwd2").val())
                return w("#regist_pwd2", "重复密码输入不一致，请重新输入");
            var s = {
                Name: e,
                PassWord: t
            };
            L.UserAPI.Regist(s, function(e) {
                e.code ? l() : (w("#regist_name", e.message || "注册失败"),
                HideAndShow("#regist_panel"))
            })
        }
    };
    function a() {
        ...
        if (!t.is(":disabled")) {
            ...
            if (e.is(":disabled"))
                ...
                if (!s)
                    return w(e, "请输入你的帐号绑定的手机号码");
                if (!/^(13[0-9]|14[579]|15[0-3,5-9]|16[6]|17[0135678]|18[0-9]|19[89])\d{8}$/.test(s))
                    return w(e, "手机号码格式错误")
            }
            ...
            t.html("120秒后重新发送"),
            function e(t, s) {
                120 == t ? (s.prop("disabled", !1),
                s.html("发送验证码")) : (s.html(120 - t + "秒后重新发送"),
                t++,
                window.setTimeout(e.bind(this, t, s), 1e3))
            }(0, t)
        }
    }
    function l() {
        if (!n)
            return k("正在获取服务器列表"),
            void L.UserAPI.GetServer(function(e) {
                ...
                function() {
                    ...
                    for (var e = [], t = ["武神传说", "武神传说", "武神传说", "武神传说"], s = 0; s < n.length; s++)
                        n[s].IsTest && "?test" != window.location.search && "localhost" != window.location.hostname && "test.wsmud.com" !== window.location.host ? n.splice(s, 1) : (e.push("<li class='role-item"),
                        0 == s && e.push(" select"),
                        e.push("' index='" + s + "'>"),
                        e.push(t[s]),
                        e.push("&nbsp;&nbsp;"),
                        e.push(n[s].Name),
                        n[s].IsRcd && e.push("<span style='color:red;font-size:0.5rem;line-height:2rem;height:2rem;'>&nbsp;（推荐）</span>"),
                        e.push("</li>"));
    ...
    function r(e) {
        ...
        return p && (t.closest(".chat-panel").length || ($(".chat-panel").addClass("hide"),
        p = !1)),
        F.Close(),
        !1
    }
    function c(e) {
        if (!_)
            return i && i.Connected() ? void i.Send(e) : (t = e,
            S("<red>连接中断，正在重新连线...</red>"),
            void g(s))
    }
    function m() {
    ...
    function g(e, t) {
        ...
        i.OnError = function(e, t) {
            _ = !1,
            e && (e.isTrusted && (e = "服务器没有响应，请稍后重试"),
            k("<strong>连接失败：</strong>" + e))
        }
        ,
        i.OnConnect = function() {
            _ = !1,
            t || j.player ? c(t ? h("u") + " " + h("p") + " " + t + " " + e.ID : h("u") + " " + h("p") + " " + j.player) : (k("正在获取角色列表..."),
            c(h("u") + " " + h("p")))
        }
        ,
        i.OnClose = function(e) {
            ...
            this.ChangeServer ? this.ChangeServer = !1 : this.Connected() || (j.player ? (j.clear(),
            S("<red>你的连接中断了...</red>")) : HideAndShow($("#slist_panel")))
        }
        ,
        i.OnData = y,
        i.OnMessage = S,
    ...
    function k(e, t) {
        for (var s = $(".login-content").children(), i = 0; i < s.length; i++)
            "none" == $(s[i]).css("display") || $(s[i]).is(".signinfo") || $(s[i]).hide();
    ...
    function S(e) {
        ...
        f.append(e + "\n"),
        b++,
        j.contentScroll && (u[0].scrollTop = 99999)
    }
    function y(e) {
        var t = j[e.type];
        t && t(e)
        ...
        case "name":
            $("#reg_name").val(function(e, t) {
                ...
                if (2 == t) {
                    ...
                    s.push(D[parseInt(Math.random() * D.length)]);
        ...
        case "id":
            $("#reg_id").val(function() {
                for (var e = "abcdefghijklmnopqrstuvwxyz", t = "123456789", s = [], i = parseInt(3 * Math.random()) + 3, n = 0; n < i; n++)
                    n < 3 ? s.push(e[parseInt(Math.random() * e.length)]) : s.push(t[parseInt(Math.random() * t.length)]);
                return s.join("")
            }());
            break;
        case "prop":
    ...
    var j = {
        ...
        init: function() {
            j.itemsElement = $(".room_items"),
            (u = $(".content-message")).on("mousedown", function() {
                j.contentScroll = !1
            }),
        ...
        onContentScroll: function(e) {
            j.auto_scroll ? j.auto_scroll = !1 : j.contentScroll ? (setTimeout(function() {
                j.contentScroll = !0
            }, 4e3),
            j.contentScroll = !1) : u[0].scrollTop + u.height() >= u[0].scrollHeight && (j.contentScroll = !0)
        },
        regist: function(e) {
        ...
        flash: function() {
            f && (j._flash_show ? (f.find("fla").hide(),
            j._flash_show = !1) : (f.find("fla").show(),
            j._flash_show = !0))
        },
        emote: function(e) {
            j.emotes = e.items || 0;
            for (var t = [], s = 0; s < j.emotes.length; s++)
                t.push("<span>"),
                t.push(j.emotes[s]),
                t.push("</span>");
        ...
        cross: function(e) {
            ...
            i.Close(),
            M.pack.items = null,
            "duizhan" == e.cross_type && (M.skills.items = null,
            M.skills.isShow = !1),
        ...
        login: function(e) {
            j.player || HideAndShow(".container"),
            j.player = e.id,
            q.load(e.setting),
            t && (c(t),
            t = null)
        ...
        itemadd: function(e) {
            if (!q.off_plist || !e.p || e.id == j.player) {
                var t, s = e;
                t = q.item_firstme && s.id == j.player ? $(j.create_roomitem(s)).prependTo(j.itemsElement) : $(j.create_roomitem(s)).appendTo(j.itemsElement),
                E.STATUS[e.id] && j.itemremove(e),
                E.AppendStatusItem(s.id, t.find(".item-status-bar"), s.status)
            }
        },
        items: function(e) {
            j.itemsElement.empty(),
            E.STATUS = {};
            for (var t = 0; t < e.items.length; t++) {
                var s, i = e.items[t];
                if (i)
                    if (!q.off_plist || !i.p || i.id == j.player)
                        s = q.item_firstme && i.id == j.player ? $(j.create_roomitem(i)).prependTo(j.itemsElement) : $(j.create_roomitem(i)).appendTo(j.itemsElement),
        ...
        create_roomitem: function(e) {
            ...
            E.IsShow && !q.off_hp || t.push(' style="display:none;"'),
            t.push(">"),
            t.push('<div class="progress hp"><div class="progress-bar" max="' + e.max_hp + '"  style="width:' + j.countwidth(e.hp, e.max_hp) + '%"></div></div>'),
            t.push('<div class="progress mp"><div class="progress-bar" max="' + e.max_mp + '"   style="width:' + j.countwidth(e.mp, e.max_mp) + '%"></div></div>'),
            t.push("</div>")),
            t.push("<span class='item-status-bar'>"),
            t.push("</span>"),
            t.push("<span class='item-name'>"),
            t.push(e.name),
            q.show_hpnum && e.max_hp && t.push('<span class="progress-num">[' + this.get_hpnum(e.hp, e.max_hp) + "<nor>/</nor><hiy>" + e.max_hp + "</hiy>]</span>"),
            t.push("</span>"),
            t.push("</div>"),
            t.join("")
        },
        room: function(e) {
            ...
            j.room_name = e.name,
            !q.keep_msg && f ? (f.remove(),
            f = null,
            b = 0) : q.keep_msg && S("你来到了" + e.name + "。"),
            j.room_path != e.path) {
        ...
        exits: function(e) {
            var t = e ? e.items : j.room_exits;
            if (t)
                if (j.room_exits = t,
                q.exits_dir) {
                    for (var s = ["这里明显的出口有："], i = [], n = 0; n < A.DIRS.length; n++)
                        t[A.DIRS[n]] && i.push(A.DIRS[n]);
                    ...
                    $(".room_exits").html(A.CreateExitsMap(t, $(".container").width(), j.room_name))
        },
        ...
        click_exits: function(e) {
            var t = $(e.target)
              , s = t.attr("dir");
            s && (t.is("rect") ? t.attr("fill", "#232323") : t.is("text") && t.prev().attr("fill", "#232323"),
            c("go " + s))
        },
        item: function(e) {
            if (S(e.desc),
            e.commands) {
                for (var t = ["<div class='item-commands'>"], s = 0; s < e.commands.length; s++)
                    t.push("<span cmd='" + e.commands[s].cmd + "'>"),
                    t.push(e.commands[s].name),
                    t.push("</span>");
                if (t.push("</div>"),
                q.show_command && E.STATUS[e.id]) {
                    j.itemsElement.find(".item-commands").remove();
        ...
        combat: function(e) {
            e.start && (1 != q.auto_showcombat || E.IsShow || E.Show(),
            1 == q.auto_hideroom && (q.hide_roomdesc || $(".room_desc").hide())),
            e.end && 1 == q.auto_hideroom && (q.hide_roomdesc || $(".room_desc").show())
        },
        state: function(e) {
            if (e && e.state) {
                ...
                j.states = e.desc,
                j.timer && clearInterval(j.timer),
                j.states && j.states.length && ("string" == typeof j.states && (j.states = [j.states]),
                j.timer = setInterval(j.updatestate, e.interval || 5e3))
            } else
        ...
        updatestate: function() {
            if (j.states && i) {
                var e = j.states.length;
                S(j.states[parseInt(Math.random() * e)])
            }
        },
        die: function(e) {
            if (e.relive)
        ...
        msg: function(e) {
            ...
            if (t)
                if (q.no_spmsg)
                    ...
                    j.ChannelElement || (j.ChannelCount = 0,
                    j.ChannelElement = $("<div class='channel'><pre></pre></div>").insertBefore(u),
                    j.ChannelPro = j.ChannelElement.find("pre"),
                    j.ChannelElement.on("click", M.channel.show.bind(M.channel)),
                    j.ChannelElement.on("mousedown", M.channel.endScroll),
                    j.ChannelElement.on("mouseup", M.channel.beginScroll));
                    var s = M.channel.isBottom();
                    1 == M.channel.datas.length && j.ChannelPro.empty(),
                    j.ChannelPro.append(t),
                    s && M.channel.scrollBottom()
                }
        },
      ...
      , T = {
        ...
        Settop: function() {
            for (var e = 0, t = 0; t < T.Elemes.length; t++) {
                var s = T.Elemes[t];
                s.css("bottom", e),
                e += s.height() + 14
            }
      ...
      , E = {
        ...
        ChangeDistime: function(e) {
            for (var t = e.id.replace("/", "."), s = 0; s < E.dis_pfms.length; s++)
                if (E.dis_pfms[s].id == t) {
        ...
        ClearDistime: function(e) {
            if (E.dis_pfms)
                for (var t = e.id ? e.id.replace("/", ".") : e.id, s = 0; s < E.dis_pfms.length; s++) {
        ...
        On_Perform: function(e) {
            if (this.Skills) {
                ...
                for (var t = 0; t < this.dis_pfms.length; t++)
                    this.dis_pfms[t].id != e.id ? this.dis_pfms[t].ani_time < e.rtime && (this.dis_pfms[t].ani_time = e.rtime,
                    this.dis_pfms[t].distime = e.rtime) : (e.id = null,
                    this.dis_pfms[t].distime = e.distime,
                    this.dis_pfms[t].ani_time = e.distime);
                ...
                e.rtime > E.ani_time && (E.distime = e.rtime,
                E.ani_time = e.rtime),
        ...
        ANI_PFM: function() {
            for (var e = 100 * E.ani_time / E.distime, t = 0; t < E.Skills.length; t++) {
                for (var s = E.Skills[t], i = e, n = 0; n < E.dis_pfms.length; n++)
                    if (E.dis_pfms[n].id == s.id && E.dis_pfms[n].distime) {
        ...
        UpdaeBar: function(e, t, s) {
            ...
            if (null != i) {
                ...
                if (e["max_" + t] ? (n = e["max_" + t],
                o.attr("max", n)) : n = parseInt(o.attr("max")),
                q.show_hpnum && "hp" == t && s.find(".progress-num").html("[" + j.get_hpnum(i, n) + "<nor>/</nor><hiy>" + n + "</hiy>]"),
                o.css("width", E.CountWidth(i, n) + "%"),
                q.show_damage && e.damage && e.id != j.player) {
                    var a = 0;
                    a = -1 == e.damage ? parseInt(1e3 * (n - i) / n) / 10 : parseInt(1e3 * e.damage / n) / 10,
                    (o = s.find(".item-damage")).length || (o = $('<span class="item-damage">[<hiy>0%</hiy>]<span>').appendTo(s.find(".item-name"))),
                    o.html("[<hiy>" + a + "%</hiy>]")
                }
            }
        },
        ...
        StatusItem_override: function(e, t) {
            var s = e.items[t.sid];
            s && (s.handler && clearTimeout(s.handler),
            s.anitime = s.duration,
            E.StatusItemANI(s))
        },
    ...
    var A = {
        ...
        CreateExitsMap: function(e, t, s) {
            ...
            var n = 40
              ...
              , a = 10
              , l = {};
            for (var h in e.north && e.up && (e.north_2 = e.up,
            delete e.up),
            e.south && e.down && (e.south_2 = e.down,
            delete e.down),
            e)
                -1 < h.indexOf("south") || "down" == h || "out" == h ? l.s = !0 : (-1 < h.indexOf("north") || "up" == h || "enter" == h) && (l.n = !0);
            l.s && (n += 30),
            l.n && (n += 30,
            a += 30);
            var r = [];
            for (var h in r.push('<svg style="margin-left:-2em" height="' + n + '" width="' + t + '">'),
            r.push('<rect x="' + o + '" y="' + a + '"  fill="dimgrey" stroke-width="1" stroke="gray" '),
            r.push('width="60" height="20"></rect>'),
            r.push(' <text x="' + (o + 30) + '" y="' + (a + 14) + '"  text-anchor="middle" style="font-size:12px;" '),
            this.pushName(r, s, !0),
            e) {
                var c, m, d;
                switch (h) {
                ...
                r.push('width="60" height="20"></rect>'),
                r.push(' <text x="' + (d[0] + 30) + '" y="' + (d[1] + 14) + '" dir="' + h + '" text-anchor="middle" style="font-size:12px;"'),
                this.pushName(r, p, !1),
                c && (r.push('<line  stroke="gray" '),
                r.push(" x1='" + c[0] + "' y1='" + c[1] + "' x2='" + m[0] + "' y2='" + m[1] + "'"),
                -1 < h.indexOf("up") || -1 < h.indexOf("down") ? (r.push(" stroke-dasharray='5,5'"),
                r.push(" stroke-width='10'")) : r.push(" stroke-width='1'"),
                r.push("></line >"))
            }
            return r.push("</svg>"),
            r.join("")
        ...
        ShowMap: function(e, t) {
            if (e) {
                ...
                var r = 0
                  , c = h.width();
                if (A.MapWidth < c && (r = (c - A.MapWidth) / 2,
                A.MapWidth = c),
                A.MapHeight = 50 * (i.maxY + o + 1),
                !(A.MapWidth < 0 || A.MapHeight < 0)) {
                    ...
                    for (var m = 0; m < e.length; m++) {
                        ...
                        if (u)
                            for (var f = 0; f < u.length; f++) {
                                ...
                                v && (s.push('<line  stroke="gray" '),
                                s.push(" x1='" + v[0] + "' y1='" + v[1] + "' x2='" + _[0] + "' y2='" + _[1] + "'"),
                                RegExp.$3 && s.push(" stroke-dasharray='5,5'"),
                                "l" == RegExp.$3 ? s.push(" stroke-width='10'") : s.push(" stroke-width='1'"),
                                s.push("></line >"))
                            }
                        s.push(' <text x="' + (d + 30) + '" y="' + (p + 14) + '" text-anchor="middle" style="font-size:12px;" '),
                        this.pushName(s, e[m].n, !0)
                    }
                    s.push("</svg>"),
                    h.html(s.join("")),
                    this.MapContent = $("svg"),
        ...
        LoadMap: function() {
            ...
            if (e) {
                ...
                return t == this.CurMapID ? ($(".map-panel").slideDown("fast"),
                void (this.IsShow = !0)) : A.Buffer[t] ? A.ShowMap(A.Buffer[t], t) : void c("map " + t)
            }
        },
        ...
        UpdateMap: function(e, t) {
            ...
            if (s) {
                if (!t.id)
                    return A.Buffer[e] = null,
                    void (this.CurMapID == e && (this.CurMapID = null));
                for (var i = 0; i < s.length; i++)
                    if (s[i].id == t.id) {
                        s[i].n = t.n || s[i].n,
                        s[i].p = t.p || s[i].p,
      ...
      , M = {
            ...
            if (e)
                if (t)
                    ...
                    if (this.isShow && e == this.curItem)
                        return this.hide();
                    this.curItem && e != this.curItem && (M[M.curItem].close && M[M.curItem].close(),
                    M[M.curItem].isShow = !1,
                    M.contentElement.empty()),
                    this.init(),
                    this.curItem = e,
                    this[e].show(t)
                }
        ...
        init: function() {
            ...
            this.footerElement = $(".dialog>.dialog-footer").on("click", ".footer-item", M.footerClick),
            this.hiddenElement = $(".hidden-item"),
            this.element = $(".dialog"),
            $(".dialog>.dialog-header>.dialog-close").on("click", M.hide),
            this.isInit = !0),
        ...
        hide: function() {
            M[M.curItem].hide && 0 == M[M.curItem].hide() || (M.isShow = !1,
            $(".content-room").removeClass("hide"),
            M.element.addClass("hide"))
        },
        ...
        score: {
            ...
            onData: function(e) {
                ...
                e.titles)
                    ...
                    this.uid != j.player ? M.footerElement.find(".footer-item:eq(2)").hide() : M.footerElement.find(".footer-item:eq(2)").show());
            ...
            show: function(e) {
                e || (this.selectIndex ? 1 == this.selectIndex ? c("score2") : c("score title") : c("score"),
                this.init_elem())
            },
            close: function() {
            ...
            footerChanged: function(e) {
                ...
                1 == e ? this.uid && j.player != this.uid ? c("score2 " + this.uid) : c("score2") : 2 == e && (this.titles || c("score title"),
                t.on("click", ".btn-noused", function(e) {
                    var t = $(e.target);
                    t.is("red") && (t = t.parent());
                    for (var s = parseInt(t.attr("index")), i = 0; i < this.titles.length; i++)
                        this.titles[i].use = i == s && !this.titles[i].use;
                    c("title " + s),
                    this.create_titles()
                }
                .bind(this)))
        ...
        map: {
            ...
            show: function() {
                ...
                M.footer(""),
                this.element = $(".map"),
                M.contentElement.append(this.element),
                M.icon("map-marker"),
                M.iconElement.attr("class", "dialog-icon glyphicon glyphicon-map-marker")
            },
            hide: function() {
                this.element.remove(),
    ...
    function P(e) {
        if (!e)
            return "";
        var t = [];
        return 1e4 <= e && (t.push(parseInt(e / 1e4) + "两<hiy>黄金</hiy>"),
        e %= 1e4),
    ...
    M.skills = {
        ...
        updateSkill: function(e) {
            if (this.skills) {
                ...
                } else if (null != e.exp || null != e.level)
        ...
        onData: function(e) {
            if (e) {
                if (!this.isShow && M.master.isShow && null == e.exp && !e.item)
                    return M.master.onData(e);
                if (e.item)
        ...
        show: function() {
            ...
            this.element.on("click", ".skill-item", M.skills.item_click),
            this.element.appendTo(M.contentElement),
            this.element.removeClass("hide-item"),
            this.items ? (c("cha none"),
            M.title(this.title),
            M.icon("book"),
            this.create_footer()) : c("cha"))
        },
        ...
        createSkillItem: function(e, t) {
            ...
            if (i && s.push(" enable"),
            s.push('" skid="' + e.id + '">'),
            i ? s.push(e.name.replace(">", ">✔")) : s.push(e.name),
            e.enable_skill && t) {
                var n = t[e.enable_skill];
                n && (s.push('<span class="enable_skill">已装备：'),
                s.push(n.name),
                s.push("</span>"))
            }
            ...
            s.push("%"),
            s.push("&nbsp;"),
            s.push(M.skills.get_lvdesc(e.level)),
            s.push("</span></div>"),
            s.join("")
        },
        sort_items: function(e) {
            if (!e || !q.auto_sortitem)
                return e;
        ...
        get_lvdesc: function(e) {
            if (e < 1e3)
                return M.skills.skill_levels[parseInt(e / 50)];
            var t = parseInt((e - 1e3) / 500);
            return 6 < t && (t = 6),
            M.skills.skill_levels[t + 20]
        },
        ...
        item_click: function() {
            ...
            if (s) {
                if (t.push('<span cmd="checkskill ' + s.id + '">查看详细</span>'),
                s.can_enables)
                ...
                t.push("</div>"),
                M.skills.element.find(".item-commands").remove(),
                $(t.join("")).appendTo(e)
            }
        }
    },
    M.master = {
        ...
        onData: function(e) {
            ...
            if (e.master || e.follower) {
                ...
                e.limit && (this.is_follower ? M.footer("<span class='obj-money'>" + e.target + "目前的技能上限为<HIC>" + e.limit + "</HIC>级</span>") : M.footer("<span class='obj-money'>你目前的技能上限为<HIC>" + e.limit + "</HIC>级</span>"))
            }
        },
        show: function() {
        ...
        item_click: function() {
            ...
            if (t) {
                ...
                if (s.push('<span cmd="checkskill ' + t.id + " " + M.master.master + '">查看详细</span>'),
                s.push('<span cmd="xue ' + e.attr("skid") + " from " + M.master.master + '">学习</span>'),
                M.master.is_follower) {
                    var i = "dc " + M.master.master;
                    if (s.push('<span cmd="_confirm ' + i + " fangqi " + e.attr("skid") + '">遗忘</span>'),
                    s.push('<span cmd="' + i + " lianxi " + e.attr("skid") + '">练习</span>'),
                    t.can_enables)
                ...
                s.push("</div>"),
                M.master.element.find(".item-commands").remove(),
                $(s.join("")).appendTo(e)
            }
        }
    },
    M.pack = {
        ...
        updateitem: function(e) {
            if (this.items) {
                ...
                var s;
                if (null != e.uneq)
                    return (s = this.eqs[e.uneq]).can_eq = 1,
                    s.count = 1,
                    this.items.push(s),
                    !(this.eqs[e.uneq] = null);
                if (e.jldesc)
                    return (n = []).push(e.jldesc),
                ...
                if (e.desc) {
                    ...
                    var o = e.from;
                    if ("eq" == o)
                        n.push('<span cmd="' + this.command_before + "uneq " + e.id + '">取消装备</span>');
                    else if ("item" == o) {
                        var a = this.get_item(e.id);
                        a && this.create_item_command(a, n, e.commands)
                    } else
                        "store" == o ? n.push('<span cmd="_confirm qu ' + e.id + '">取出</span>') : "sj" == o ? n.push('<span cmd="_confirm qu ' + e.id + '">取出</span>') : n.push('<span cmd="_confirm buy ' + e.id + " from " + M.list.seller + '">购买</span>');
                    return n.push("</span>"),
                    this.show_sub(n.join("")),
                    !1
                }
                ...
                return e.name ? ((s = this.get_item(e.id)) ? (s.count = e.count,
                s.name = e.name) : this.items.push(e),
                !0) : !!e.max_item_count && (this.max_count = e.max_item_count,
                S((M.pack2.isShow ? M.pack2.target_name : "你") + "的背包容量扩充为" + this.max_count + "。"),
                !0)
            }
        },
        ...
        show_sub: function(e) {
            ...
            M.list.isShow && (t = M.list.rightElement),
        ...
        onData: function(e) {
            if (e) {
                if (e.items)
                    ...
                    if (M.pack2.isShow && !e.name)
                        return M.pack2.onData(e);
                    if (0 == this.updateitem(e))
                        return
                }
                this.isShow ? (this.show_items(),
                this.show_moeny()) : (M.list.isShow && M.list.update_pack(e),
                M.trade.isShow && M.trade.update_pack(e))
            }
        },
        show_moeny: function() {
        ...
        show_items: function() {
            ...
            M.title(this.items && this.items.length ? e + "身上共有" + this.items.length + "/" + this.max_count + "件物品" : e + "身上没有任何东西")
        },
        ...
        show: function() {
            ...
            this.isShow)
                return c(this.items ? "pack none" : "pack");
            this.isShow = !0,
            this.init_element(),
            this.packElement.on("click", ".obj-item", M.pack.item_click),
            this.eqElement.on("click", ".eq-item", M.pack.eqitem_click),
            this.element.appendTo(M.contentElement),
            this.items ? (c("pack none"),
            this.show_items()) : c("pack")
        },
        create_eqs: function() {
        ...
        create_item_command: function(e, t, s) {
            ...
            this.command_before && t.push('<span cmd="_confirm ' + this.command_before + "give " + j.player + " " + e.count + " " + e.id + '">拿来</span>'),
            s)
                for (var i = 0; i < s.length; i++)
    ...
    M.pack2 = {
        ...
        item_click: function() {
            ...
            if (t) {
                ...
                if (M.pack2.element.find(".item-commands").remove(),
                s) {
                    var i = ["<span class='item-commands'>"];
                    i.push('<span cmd="' + M.pack2.command_before + " checkobj " + s.id + ' from item">查看</span>'),
                    M.pack2.create_item_command(s, i),
                    i.push("</span>"),
                    $(i.join("")).appendTo(e)
                }
            }
    ...
    M.trade = {
        ...
        onData: function(e) {
            this.isShow || M.show("trade"),
            M.title("和" + e.name + "交易中");
            M.pack.items;
            this.trade_target = e.target,
            this.trade_list.length = 0,
            M.pack.items ? this.update_pack() : c("pack"),
            M.pack.isShow = !1,
        ...
        show: function(e) {
            ...
            this.element.appendTo(M.contentElement.empty()),
            this.create_footer(),
            this.isShow = !0)
        },
        create_footer: function() {
        ...
        footerChanged: function(e) {
            if ((e = parseInt(e)) && this.trade_list.length)
                for (e = 0; e < this.trade_list.length; e++)
                    c("give " + this.trade_target + " " + this.trade_list[e].count + " " + this.trade_list[e].id);
            M.hide()
        },
        ...
        right_click: function() {
            ...
            if (!e.is(".disabled")) {
                ...
                if (t) {
                    var s = M.pack.get_item(t);
                    if (s)
                        return 1 < s.count ? F.Show_trade_add(s) : M.trade.add_trade(s),
                        !1
                }
            }
        },
    ...
    M.list = {
        ...
        updateitem: function(e) {
            if (e.store) {
                ...
                0 == t.count && M.pack.items.Remove(t)
            } else if (e.sell) {
            ...
            M.title("你的仓库中有" + this.stores.length + "/" + this.max_store_count + "件物品")),
            this.update_pack(),
        ...
        onData: function(e) {
            ...
            e) {
                ...
                e.gongji ? this.money_name = "门派功绩" : e.jungong && (this.money_name = "军功"),
                this.selllist = e.selllist,
                this.create_items(e.selllist, this.leftElement, 2, e.selllist.length),
                M.titleElement.html(e.title),
                M.icon("shopping-cart")),
                this.update_pack(),
                e.stores && (this.create_items(e.stores, this.leftElement, 3, e.max_store_count),
                this.isstore = !0,
                this.stores = e.stores,
                this.is_bookshelf = !!e.bookshelf,
                M.titleElement.html(this.is_bookshelf ? "你的书架上有" + e.stores.length + "/" + e.max_store_count + "本秘籍" : "你的仓库中有" + e.stores.length + "/" + e.max_store_count + "件物品"),
        ...
        show: function(e) {
            M.isShow && "list" == M.curItem || M.show("list"),
            ...
            this.leftElement = $(this.element.children()[0]),
            this.rightElement = $(this.element.children()[1])),
            this.element.on("click", ".obj-item", M.list.item_click),
            this.element.appendTo(M.contentElement.empty()),
            this.isShow = !0)
        },
        ...
        update_pack: function() {
            var e = M.pack.items;
            e ? (this.create_items(e, this.rightElement, 1, M.pack.max_count),
            this.show_footer(M.pack.money)) : c("pack")
        },
        create_items: function(e, t, s, i) {
            ...
            for (var a = 0; a < i; a++) {
                ...
                2 == s ? (n.push("每"),
                n.push(l.unit),
                n.push(this.money_name ? l.value + "<hiy>" + this.money_name + "</hiy>" : P(l.value)),
                -1 == l.count ? n.push("：大量现货") : (n.push("：剩余"),
                n.push(l.count),
                n.push(l.unit))) : 1 != s || this.isstore ? 1 < l.count && (n.push(l.count),
                n.push(l.unit)) : l.value ? (n.push("每"),
                n.push(l.unit),
                n.push(P(l.value)),
                n.push("："),
                n.push(l.count),
        ...
        item_click: function() {
            ...
            if (i) {
                ...
                M.list.isstore ? 3 == s ? (n.push('<span cmd="checkobj ' + t + " from " + (M.list.is_bookshelf ? "sj" : "store") + '">查看</span>'),
                n.push('<span cmd="_confirm qu ' + t + '">取出</span>')) : 1 == s && (n.push('<span cmd="checkobj ' + t + ' from item">查看</span>'),
                M.list.is_bookshelf ? n.push('<span cmd="_confirm store ' + i.count + " " + t + '">放到书架</span>') : n.push('<span cmd="_confirm store ' + i.count + " " + t + '">存到仓库</span>')) : 2 == s ? (n.push('<span cmd="checkobj ' + t + " from " + M.list.seller + '">查看</span>'),
                i.count && n.push('<span cmd="_confirm buy ' + i.count + " " + t + " from " + M.list.seller + '">购买</span>')) : 1 == s && (n.push('<span cmd="checkobj ' + t + ' from item">查看</span>'),
                n.push('<span cmd="_confirm sell ' + i.count + " " + t + " to " + M.list.seller + '">卖掉</span>')),
                n.push("</div>"),
                M.list.element.find(".item-commands").remove(),
                $(n.join("")).appendTo(e)
            }
        }
    },
    M.channel = {
        ...
        show: function() {
            if (500 < Date.now() - this.last_click)
                ...
                M.contentElement.html("").append(j.ChannelElement.addClass("channel-dialog")),
                M.channel.isShow = !0,
                M.channel.scrollBottom()
            }
        },
        hide: function() {
            M.channel.footerChanged(""),
            j.ChannelElement.removeClass("channel-dialog").insertBefore(u),
            this.scrollBottom(),
            this.isShow = !1
        },
        close: function() {
        ...
        scrollBottom: function() {
            M.channel.isScroll && (j.ChannelElement[0].scrollTop = 999999)
        },
        isBottom: function() {
            return !0
        },
    ...
    M.setting = {
        ...
        footerChanged: function(e) {
            ...
            this.selectitem.appendTo(M.contentElement)
        },
        helpClick: function() {
        ...
        save_custom: function() {
            if ($(".dialog-custom>.setting-item[for='auto_pfm']>.switch").is(".on")) {
                if (!(e = $("#auto_pfm").val()))
                    return S("<hir>你没有设置自动出招的绝招。</hir>");
                if (300 < e.length)
                    return S("<hir>你设置的出招过长。</hir>");
                q.save("auto_pfm", e)
            }
            if ($(".dialog-custom>.setting-item[for='auto_pfm2']>.switch").is(".on")) {
                if (!(e = $("#auto_pfm2").val()))
                    return S("<hir>你没有设置自动反击的绝招。</hir>");
                if (300 < e.length)
                    return S("<hir>你设置的出招过长。</hir>");
                q.save("auto_pfm2", e)
            }
            if ($(".dialog-custom>.setting-item[for='auto_work']>.switch").is(".on")) {
                var e;
                if ((e = $("#auto_work").val()) && 300 < e.length)
                    return S("<hir>你设置的过长。</hir>");
        ...
        get_pfms: function(e) {
            if (!E.Skills)
                return S("<hir>你没有可用的绝招设置。</hir>");
            for (var t = [], s = 0; s < E.Skills.length; s++)
                0 < t.length && t.push(","),
    ...
    M.tasks = {
        ...
        show: function() {
            ...
            c("tasks"),
            this.isShow || (this.element.appendTo(M.contentElement),
            M.footer(""),
            this.isShow = !0)
        },
    ...
    M.stats = {
        ...
        onData: function(e) {
            return e.close ? M.hide() : e.tops ? (e.top ? this.show_desc("你目前在第" + e.top + "名") : this.show_desc("你目前没有上榜"),
        ...
        show: function() {
            ...
            M.icon("stats"),
            M.contentElement.html(this.element),
        ...
        footerChanged: function(e) {
            ...
            t != this.selectedItem && (this.selectedItem = t,
            M.title(this.selectedItem.name),
            c("stats " + this.selectedItem.cmd))
        },
        itemClick: function() {
            var e = $(this)
            ...
            !M.stats.top || t < M.stats.top ? n.push('<span cmd="challenge ' + t + '">挑战</span>') : t == M.stats.top && n.push('<span cmd="stats copy">更新应战状态</span>'),
            ...
            n.push("</div>"),
            M.stats.element.find(".item-commands").remove(),
            $(n.join("")).appendTo(e)
        }
    },
    M.jh = {
        ...
        onData: function(e) {
            if (e.close)
                return M.isShow && M.hide();
            if (e.desc) {
                if ("fb" == e.t) {
                    if (!(t = this.fbs[e.index]))
                        return;
        ...
        select: function(e) {
            ...
            if (t.length && !t.is(".selected")) {
                ...
                i / 2 < s && (s = (i - t.height()) / 2,
                M.jh.listElement[0].scrollTop = s),
                M.jh.selectedItem && M.jh.selectedItem.removeClass("selected"),
                M.jh.selectedItem = t,
                M.jh.selectedItem.addClass("selected")
            }
        },
        ...
        footerChanged: function(e) {
            ...
            this.selectedItem && this.selectedItem.is(".fb-item") || c("jh fb " + this.unlock)))
        },
    ...
    M.shop = {
        ...
        show_moeny: function() {
            this.isShow && (window.isios ? M.footer("<div class='dialog-shop-footer'>你身上有<hij> " + this.cash_money + " 元宝</hij><span cmd='transmoney'>账号转入</span></div>") : M.footer("<div class='dialog-shop-footer'>你身上有<hij> " + this.cash_money + " 元宝</hij><span cmd='transmoney'>账号转入</span><span cmd='pay'>充值</span><span cmd='tg'>推广</span></div>"))
        },
        show: function(e) {
            this.element || (this.element = $("<div class='dialog-shop'></div>")),
            this.isShow || (M.title("商品列表"),
            M.icon("shopping-cart"),
            this.isShow = !0,
            this.element.appendTo(M.contentElement),
            this.selllist ? this.show_moeny() : c("shop"))
        },
    ...
    M.message = {
        ...
        showChild: function() {
            ...
            M.contentElement.html(e.element),
        ...
        showMessageDetail: function() {
            ...
            e && (c("message " + e),
            M.message.element.addClass("detail"))
        },
    ...
    M.party = {
        ...
        onData: function(e) {
            if (e.name) {
                ...
                for (var i = 0; i < t.roles.length; i++) {
                    var n = t.roles[i];
                    n.id == j.player && (this.level = n.level),
        ...
        show_commands: function() {
            ...
            if (e) {
                var t = ["<div class='item-commands'>"];
                e.id == j.player ? (t.push('<span cmd="party out">退出帮派</span>'),
                1 == M.party.level && t.push('<span cmd="party dissmiss">解散</span>')) : (e.level > M.party.level - 1 && 2 < e.level && t.push('<span cmd="party uplevel ' + e.id + '">提升为' + M.party.levels[e.level - 1] + "</span>"),
                e.level > M.party.level && e.level < 5 && t.push('<span cmd="party downlevel ' + e.id + '">降级为' + M.party.levels[e.level + 1] + "</span>"),
                1 == M.party.level && 2 == e.level && t.push('<span cmd="party trans ' + e.id + '">让位</span>'),
                e.level > M.party.level && t.push('<span cmd="party remove ' + e.id + '">开除</span>'),
                e.online && t.push('<span cmd="team add ' + e.id + '">邀请组队</span>')),
                1 != t.length && (t.push("</div>"),
                M.party.element.find(".item-commands").remove(),
                $(t.join("")).appendTo(this))
            }
        },
        close: function() {
            this.element.remove(),
    ...
    M.team = {
        ...
        onData: function(e) {
            ...
            e.items.length ? this.isCap = e.items[0].id == j.player : this.isCap = 0),
        ...
        clickItem: function() {
            ...
            if (t) {
                ...
                var i = M.team.items[0].id == j.player;
                i && t.id != j.player ? s.push('<span cmd="team remove ' + t.id + '">移出队伍</span>') : t.id == j.player && s.push('<span cmd="team out ' + t.id + '">退出队伍</span>'),
                i && t.id == j.player && s.push('<span cmd="team set">更改分配方式</span>'),
                s.push("</div>"),
                M.team.element.find(".item-commands").remove(),
                $(s.join("")).appendTo(e)
            }
        }
    },
    ...
    var q = {
        ...
        set_prop: function(e, t) {
            ...
            case "item_firstme":
                if (1 == t) {
                    var s = $(".room_items>.room-item[itemid='" + j.player + "']");
            ...
            case "show_command":
                ...
                break;
            case "no_spmsg":
                j.ChannelElement && (t ? j.ChannelElement.hide() : j.ChannelElement.show())
            }
        },
        save: function(e, t) {
            this[e] = t,
    ...
    var F = {
        ...
        Close: function() {
            F.isShow && (F.element.css("bottom", -F.Parameter.height),
            setTimeout(function() {
                F.element.hide()
            }, 200),
            F.isShow = !1)
        ...
        Show_store: function(e) {
            var s = e[3];
            if (s)
                return 1 == e[2] ? c((M.list.is_bookshelf ? "sj " : "") + "store " + s) : void this.Show({
                    ...
                    onOK: function() {
                        ...
                        "NaN" == t.toString() && (t = 0),
                        t && (t > F.max_count && (t = F.max_count),
                        c((M.list.is_bookshelf ? "sj " : "") + "store " + t + " " + s))
                    }
                })
        },
        Show_fenjie: function(e, t) {
            ...
            if (s) {
                ...
                if (i)
                    return -1 == i.name.indexOf("★") ? c("fenjie " + s) : void this.Show({
        ...
        Show_qu: function(e) {
            ...
            if (s) {
                ...
                if (t)
                    return 1 === t.count ? c((M.list.is_bookshelf ? "sj " : "") + "qu 1 " + s) : void this.Show({
                        ...
                        onOK: function() {
                            ...
                            "NaN" == t.toString() && (t = 0),
                            t && (t > F.max_count && (t = F.max_count),
                            c((M.list.is_bookshelf ? "sj " : "") + "qu " + t + " " + s))
                        }
                    })
            }
        },
        ...
        Show_give: function(e, s) {
            ...
            if (i) {
                ...
                if (t)
                    return 1 == t.count ? c(s + "give " + j.player + " 1 " + i) : void this.Show({
                        content: this.get_countelement(t.count, t.count),
                        btn_text: "拿来",
                        onOK: function() {
                            var e = F.count_element.find("input")
      ...
      , U = {
        ...
        CookieHelper: {
            ...
            getCookie: function(e) {
                return 0 < document.cookie.length && (begin = document.cookie.indexOf(e + "="),
        ...
        to_c: function(e) {
            ...
            for (var t = "", s = 0, i = 0; e; ) {
                var n = e % 10;
                s && (s % 4 == 0 && 3 != i ? (t = U.C_STR3[s / 4] + t,
                i = 3) : n && 2 != i && (t = U.C_STR2[s % 4] + t,
                i = 2)),
                n ? ((1 != n || 10 < e || s % 4 != 1) && (t = U.C_STR[n] + t),
                i = 1) : 1 == i && (t = U.C_STR[n] + t,
                i = 0),
                e = parseInt(e / 10),
                s++
            }
        ...
        Get: function(e, t, s) {
            if (e) {
                ...
                if ($.isPlainObject(t)) {
                    for (var n in t)
                        t[n] && i.push(n + "=" + U.encode(U.Json2Str(t[n])));
                    e = e + "?" + i.join("&")
                } else if ($.isFunction(t))
                    s = t;
                else if ($.isArray(t)) {
                    for (var o = 0; o < t.length; o++)
                        i.push(U.encode(U.Json2Str(t[o])));
                    e = e + "/" + i.join("/")
                }
                var a = {
                    url: "/" + e,
        ...
        Post: function(e, t, s) {
            ...
            if ($.isPlainObject(t)) {
                for (var o in t)
                    t[o] && n.push(o + "=" + U.Json2Str(t[o]));
                i = n.join("&")
            } else {
                if (!t.length)
                    return;
                for (var a = 0; a < t.length; a++)
                    n.push(U.Json2Str(t[a]));
                i = U.Json2Str2(n)
            }
            var l = {
                url: "/" + e,
